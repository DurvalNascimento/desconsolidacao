    ...
    {!! Form::model($agente, [
        ...
        'class' => 'form-horizontal'
            ...
            <div class="form-group {{ $errors->has('email1') ? 'has-error' : ''}}">
                {!! Form::label('email1', 'Email1: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('valordesconsolmaritimo') ? 'has-error' : ''}}">
                {!! Form::label('valordesconsolmaritimo', 'Valordesconsolmaritimo: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('valordesconsolaereo') ? 'has-error' : ''}}">
                {!! Form::label('valordesconsolaereo', 'Valordesconsolaereo: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
