          ...
          <nav class="navbar navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                @else
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">{{ Auth::user()->empresa }} <span class="caret"></span></a>
          ...
          <ul class="sidebar-menu affix">
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                  ...
                  <li><a href="\registro"><i class="fa fa-circle-o"></i> Listar Registros</a></li>
                  <li><a href="\faturamento"><i class="fa fa-circle-o"></i> Faturamento</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="\clienteagente"><i class="fa fa-circle-o"></i> Listar</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> A caminho</a></li>
              </ul>
            </li>
