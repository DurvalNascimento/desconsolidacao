      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu affix">
            <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>PROCESSOS</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
               
                 
                  <li><a href="/mbl"><i class="fa fa-circle-o"></i>Marítimos</a></li>
                  <li><a href="/aereo"><i class="fa fa-circle-o"></i>Aéreos </a></li>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>FATURAMENTO</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                             
                  <li><a href="/regfat"><i class="fa fa-circle-o"></i>Faturamento Maríritimo</a></li>
                  <li><a href="/regfatar"><i class="fa fa-circle-o"></i>Faturamento Aéreo</a></li>
                  <li><a href="/notafiscal"><i class="fa fa-circle-o"></i>Nota Fiscal</a></li>
                  <li><a href="/faturamentoaereo"><i class="fa fa-circle-o"></i>Faturar Aéreos</a></li>
                  <li><a href="/faturamentomaritimo"><i class="fa fa-circle-o"></i>Faturar Marítimos</a></li>
              </ul>
            </li>

            <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>AGENTES</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
